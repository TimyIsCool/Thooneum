...
{
    const char* pszTimestamp = "The Times 22/Jan/2018 Thooneum is name of the game for new generation of firms";
...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Thooneum: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Thooneum: 2 minutes
        ...
        consensus.smartnodePaymentFixedBlock = 2000;
	...
	pchMessageStart[4] = 0x6E;//n
        pchMessageStart[5] = 0x2e;//.
        nDefaultPort = 50505;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1653429742, 0x20001fff, "main");
	...
	vSeeds.emplace_back("23.88.121.14", true);
        ...
        // Thooneum private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Thooneum BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Thooneum BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Thooneum BIP44 coin type is '5'
        ...
        vSporkAddresses = {"TVj2ccmgzNVXPiFKMHRif5t9cXnMvwo3PV"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            {
              {38159, uint256S("0x6bac4141b79b11153fa90e7ac02c219b84f5e6dfc30af86774fc525f4ce07b7b")}
        ...
        chainTxData = ChainTxData{
        	1653429742, // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
     ...
     //   consensus.DIP0003EnforcementHeight = 7300;
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Thooneum: 1 day
        consensus.nPowTargetSpacing = 60; // Thooneum: 1 minutes
        ...
        // Testnet Thooneum BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Thooneum BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Thooneum BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 10227;
	...
	// "addressgoeshere"
        ...
        chainTxData = ChainTxData{
        	1653429096, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Thooneum: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Thooneum: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
		consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("thooneumevo.org",  "devnet-seed.thooneumevo.org"));

        // Testnet Thooneum addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Thooneum addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Thooneum script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Thooneum BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Thooneum BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Thooneum BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
