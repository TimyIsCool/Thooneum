...
#error Client version information missing: version is not defined by thooneum-config.h or in any other way
#endif
...
/**
 * thooneumd-res.rc includes this file, but it cannot cope with real c++ code.
