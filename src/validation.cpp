...
#if defined(NDEBUG)
# error "Thooneum Core cannot be compiled without assertions."
#endif
                                     ...
                                     const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool fDryRun)
{
    ...
    for (const CTxIn &txin : tx.vin)
    {
        ...
        if (itConflicting != pool.mapNextTx.end())
        {
            ...
            // Transaction conflicts with mempool and RBF doesn't exist in Thooneum
...
void ThreadScriptCheck() {
    RenameThread("thooneum-scriptch");
...
static int64_t nTimeThooneumSpecific = 0;
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck = false)
{
    ...
    int64_t nTime5 = GetTimeMicros(); nTimeThooneumSpecific += nTime5 - nTime4;
    LogPrint(BCLog::BENCHMARK, "    - Thooneum specific: %.2fms [%.2fs]\n", 0.001 * (nTime5 - nTime4), nTimeThooneumSpecific * 0.000001);
