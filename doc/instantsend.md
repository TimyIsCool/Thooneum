...
This mechanism has been integrated into Bitcore-Node-Thooneum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/thooneum/insight-api-thooneum#web-socket-api](https://github.com/thooneum/insight-api-thooneum#web-socket-api)
* API: [https://github.com/thooneum/insight-api-thooneum#instantsend-transactions](https://github.com/thooneum/insight-api-thooneum#instantsend-transactions)
