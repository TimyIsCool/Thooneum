...
This document provides guidelines for internationalization of the Thooneum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `thooneum_en.ts` remains unchanged.
