...
Below are some notes on how to build Thooneum Core for Windows.
...
way. This will install to `c:\workspace\thooneum`, for example:

    make install DESTDIR=/mnt/c/workspace/thooneum
