...
rm -rf test_bitcoin.coverage/ thooneum-gtest.coverage/ total.coverage/
...
clean_exe src/thooneum-cli
clean_exe src/thooneumd
clean_exe src/thooneum-gtest
clean_exe src/thooneum-tx
