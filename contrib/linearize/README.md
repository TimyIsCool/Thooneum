# Linearize
Construct a linear, no-fork, best version of the Thooneum blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install thooneum_hash

https://github.com/thooneum/thooneum_hash
...
JSON-RPC server. Running `thooneumd` or `thooneum-qt -server` will be sufficient.
...
* `input`: thooneumd blocks/ directory containing blkNNNNN.dat
